...
public class StudentDetails extends JFrame implements ActionListener {
        ...
        String x[]={"name","fathers_name","age","DOB","address","phone","email","class x(%)","class xii(%)","aadhar","rollno","course","branch"};
...
StudentDetails(){
        ...
        l1=new JLabel("enter roll number to delete student details");
