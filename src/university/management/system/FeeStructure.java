...
public class FeeStructure extends JFrame {
    ...
    i1.setFont(new Font("Senserif",Font.BOLD |Font.ITALIC,56));
    add(i1); 
   ...
   l1.setForeground(Color.BLUE);
    ...
    m1.setFont(new Font("serif",Font.ITALIC,26));
    add(m1);
    
    m2=new JLabel("Rs 65000");
    m2.setBounds(1080,240,150,40);
    m2.setFont(new Font("serif",Font.ITALIC,26));
    add(m2);
    
    m3=new JLabel("Rs 65000");
    m3.setBounds(1080,310,150,40);
    m3.setFont(new Font("serif",Font.ITALIC,26));
    add(m3);
    
    m4=new JLabel("Rs 65000");
    m4.setBounds(1080,380,150,40);
    m4.setFont(new Font("serif",Font.ITALIC,26));
    add(m4);
