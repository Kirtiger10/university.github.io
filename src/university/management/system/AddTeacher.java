...
import java.util.Random;
 ...
 class AddTeacher implements ActionListener{
    ...
    public AddTeacher(){
      ...
      id15.setLayout(null);
      ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icon/fourth.jpg"));
        Image i3 = i1.getImage().getScaledInstance(1220, 700, Image.SCALE_DEFAULT);
        ImageIcon icc3 =new ImageIcon(i3);
        id15.setIcon(icc3);
      
        id8 = new JLabel("New Teacher Tetails");
        id8.setBounds(320,30,500,50);
        id8.setFont(new Font("serif",Font.ITALIC | Font.BOLD,25));
        ...
        String course[]={"B.Tech","BBA","BCA","Bsc","Msc","MCA","MBA","BA","BCom"};
        c1=new JComboBox(course);
        c1.setBackground(Color.WHITE);
        c1.setBounds(200,400,150,30);
        id15.add(c1);
        
        lab2=new JLabel("Departmenth");
